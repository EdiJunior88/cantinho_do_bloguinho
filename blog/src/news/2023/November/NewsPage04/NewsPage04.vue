...
/* Data 21/11/2023 */
import { cardTitle_04, cardDate_04 } from '@/components/Titles/2023/November/titles'
</script>

<template>
  <div class="container mx-auto p-10 w-10/12 rounded-3xl bg-semi-transparent leading-7">
    <header>
      <div class="text-slate-500 text-xs font-medium uppercase">Publicado em {{ cardDate_04 }}</div>
      <div class="font-title text-center py-10 font-extrabold text-3xl">{{ cardTitle_04 }}</div>
    </header>
