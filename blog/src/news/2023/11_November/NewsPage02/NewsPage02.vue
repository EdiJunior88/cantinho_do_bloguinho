...
/* Data 21/11/2023 */
import { cardTitle_11_23_02, cardDate_11_23_02 } from '@/components/Titles/2023/11_November/titles'
</script>
...
<template>
  <div class="container mx-auto p-10 w-10/12 rounded-3xl bg-semi-transparent leading-7">
    <header>
      ...
      <div class="font-title text-center py-10 font-extrabold text-3xl">{{ cardTitle_11_23_02 }}</div>
    </header>
