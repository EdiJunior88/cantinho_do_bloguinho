...
import {
  ...
  manifest,
} from "./manifest_BIt8VMle.mjs";
import {
  A as AstroError,
  R as ResponseSentError,
  G as GetStaticPathsRequired,
  q as InvalidGetStaticPathsReturn,
  t as InvalidGetStaticPathsEntry,
  v as GetStaticPathsExpectedParams,
  w as GetStaticPathsInvalidRouteParam,
  P as PageNumberParamNotFound,
  x as ROUTE_TYPE_HEADER,
  y as MiddlewareNoDataOrNextCalled,
  z as MiddlewareNotAResponse,
  N as NoMatchingStaticPathFound,
  B as PrerenderDynamicEndpointPathCollide,
  C as ReservedSlotName,
  D as renderSlotToString,
  H as renderJSX,
  J as chunkToString,
  K as clientAddressSymbol$1,
  O as ClientAddressNotAvailable,
  S as StaticClientAddressNotAvailable,
  Q as responseSentSymbol$1,
  T as LocalsNotAnObject,
  V as clientLocalsSymbol,
  W as ASTRO_VERSION,
  X as renderEndpoint,
  Y as renderPage,
  Z as REROUTABLE_STATUS_CODES,
  _ as REROUTE_DIRECTIVE_HEADER,
  c as commonjsGlobal,
...
import {
  ...
  t as trimSlashes,
  e as appendForwardSlash,
  r as removeTrailingForwardSlash,
  f as collapseDuplicateSlashes,
} from "./chunks/astro/assets-service_C5WiLvIg.mjs";
...
class RouteCache {
  ...
  set(route, entry) {
    if (
      ...
      this.cache[route.component]?.staticPaths
    ) {
      this.logger.warn(
        null,
    ...
    if (url.pathname === base + "/" || url.pathname === base) {
      if (shouldAppendForwardSlash(trailingSlash, buildFormat)) {
        return context.redirect(
          `${appendForwardSlash(joinPaths(base, i18n.defaultLocale))}`,
        );
      } else {
    ...
    createAstro(astroGlobal, props, slots) {
      ...
      const Astro = {
        ...
        get preferredLocaleList() {
          ...
          if (args.locales) {
            preferredLocaleList = computePreferredLocaleList(
              request,
              args.locales,
            );
            return preferredLocaleList;
...
class RenderContext {
  ...
  async render(componentInstance) {
    ...
    const lastNext =
      type === "endpoint"
        ? () =>
            renderEndpoint(componentInstance, apiContext, serverLike, logger)
        : type === "redirect"
          ? () => renderRedirect(this)
          : type === "page"
            ? async () => {
...
path$9.convertPosixPathToPattern =
  path$9.convertWindowsPathToPattern =
  path$9.convertPathToPattern =
  path$9.escapePosixPath =
  path$9.escapeWindowsPath =
  path$9.escape =
  path$9.removeLeadingDotSegment =
  path$9.makeAbsolute =
  path$9.unixify =
    void 0;
const os = require$$1;
...
path$9.convertPathToPattern = IS_WINDOWS_PLATFORM
...
picomatch$2.matchBase = (
  ...
  const regex =
    glob instanceof RegExp ? glob : picomatch$2.makeRe(glob, options);
...
pattern$1.removeDuplicateSlashes =
  ...
  pattern$1.isPatternRelatedToParentDirectory =
  pattern$1.getPatternsOutsideCurrentDirectory =
  pattern$1.getPatternsInsideCurrentDirectory =
...
function processPatterns(input, settings) {
  ...
  return patterns.map((pattern) =>
    utils$a.pattern.removeDuplicateSlashes(pattern),
  );
}
/**
...
function convertPatternsToTasks(positive, negative, dynamic) {
  ...
  const patternsOutsideCurrentDirectory =
    utils$a.pattern.getPatternsOutsideCurrentDirectory(positive);
  const patternsInsideCurrentDirectory =
    utils$a.pattern.getPatternsInsideCurrentDirectory(positive);
...
common$3.joinPathSegments =
  common$3.replacePathSegmentSeparator =
  common$3.isAppliedFilter =
  common$3.isFatalError =
    void 0;
...
function walk(directory, optionsOrSettingsOrCallback, callback) {
  if (typeof optionsOrSettingsOrCallback === "function") {
    new async_1$2.default(directory, getSettings()).read(
      optionsOrSettingsOrCallback,
    );
    return;
  }
  new async_1$2.default(
    directory,
...
class Reader {
  ...
  _isFatalError(error) {
    return (
      !utils$6.errno.isEnoentCodeError(error) && !this._settings.suppressErrors
    );
  }
}
...
const _page0 = () => import("./chunks/styles_C9P54QAD.mjs");
const _page1 = () => import("./chunks/scripts_BnhbUhZ1.mjs");
const _page2 = () => import("./chunks/generic_xOwsRi1r.mjs");
const _page3 = () => import("./chunks/code01_BzUr0lhl.mjs");
const _page4 = () => import("./chunks/code02_B1QFndd0.mjs");
const _page5 = () => import("./chunks/code03_CbOOWVTd.mjs");
const _page6 = () => import("./chunks/code04_CiiBVjUm.mjs");
const _page7 = () => import("./chunks/code05_CcoYwLk8.mjs");
const _page8 = () => import("./chunks/title_DOKHH_UJ.mjs");
const _page9 = () => import("./chunks/_.._Dhy6z8pf.mjs");
const _page10 = () => import("./chunks/index_BOZRGzC3.mjs");
const pageMap = new Map([
  ...
  ["src/pages/2023/11/07/Codes/code01.md", _page3],
  ["src/pages/2023/11/07/Codes/code02.md", _page4],
  ["src/pages/2023/11/07/Codes/code03.md", _page5],
  ["src/pages/2023/11/07/Codes/code04.md", _page6],
  ["src/pages/2023/11/07/Codes/code05.md", _page7],
  ["src/pages/2023/11/07/title.ts", _page8],
  ["src/pages/2023/11/07/[...title].astro", _page9],
...
const _args = {
  middlewareSecret: "1024df6f-c0b1-4b63-b7a0-1d7a87350e6e",
};
