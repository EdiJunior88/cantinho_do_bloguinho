...
} from "../astro/assets-service_C5WiLvIg.mjs";
import {
  d as getDefaultExportFromCjs,
  A as AstroError,
  l as InvalidImageService,
  n as ExpectedImageOptions,
  E as ExpectedImage,
  o as FailedToFetchRemoteImageDimensions,
  e as createAstro,
  f as createComponent,
  p as ImageMissingAlt,
  r as renderTemplate,
  ...
  if (options.inferSize && isRemoteImage(resolvedOptions.src)) {
    try {
      ...
      throw new AstroError({
        ...
        message: FailedToFetchRemoteImageDimensions.message(
          resolvedOptions.src,
        ),
      });
    }
...
new URL(
  "file:///C:/Users/ermou/Desktop/PROGRAMACAO/cantinho_do_bloguinho/blog/.vercel/output/static/",
);
